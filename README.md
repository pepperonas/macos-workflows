...
<p align="center">
  <strong>A curated collection of 22 macOS Finder Quick Actions for image, text, and file workflows.</strong><br>
...
<a href="VERSION"><img alt="Version" src="https://img.shields.io/badge/version-1.6.0-blue?style=flat-square"></a>
...
<!-- Quality -->
<img alt="Tests" src="https://img.shields.io/badge/tests-96%20passing-success?style=flat-square">
...
| [Rename Tracks](workflows/rename-tracks/) | Normalises music filenames in a folder to `Artist - Title.ext`: title case with small words, un-shouts `ALL CAPS` artists, strips download clutter (`(Official Video)`, YouTube IDs), normalises `feat.` and typographic characters. Non-English titles keep their spelling. Shows a preview dialog first and writes an undo log. Folders only | None (Python 3 standard library) |
